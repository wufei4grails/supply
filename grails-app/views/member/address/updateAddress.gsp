    ...
    <div class="container">
      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          ...
          <g:form onSubmit="return fieldValidate(this);" data-validate="parsley" class="form-horizontal" controller="member" action="doUpdateAddress" method="post">
            ...
            <fieldset>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input value="${address.telphone}" data-type="number" data-type-number-message="收货人手机号码格式不正确" data-required-message="收货人手机号码不能为空" data-required="true" type="text" name="telphone" placeholder="请输入联系电话" class="input-xlarge">
                  <p class="help-block"></p>
                </div>
              </div>
